...
fun Red30TechNavHost(
    ...
    uiState.snackbarMessage?.let { snackbarMessage -> // Creating snackbar (notification message)
        ...
        LaunchedEffect(snackbarHostState, snackbarMessage) {
            ...
            if (result == SnackbarResult.Dismissed) { // If snackbar was shown it sets to null as it wasn't shown

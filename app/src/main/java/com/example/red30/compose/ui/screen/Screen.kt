...
sealed class Screen (
    val route: String, // This is created to minimize duplication of nav buttons
...
val topLevelScreens = listOf(Screen.Sessions, Screen.Speakers, Screen.Favorites) // This is list of screens that will be iterated thru